...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-pln5prm.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-pln5prm.containers.anotherwebservice.com/
...
```
git clone git@github.com:feralnat1988/container-pln5prm.git
cd container-pln5prm
```
...
```
docker attach container-pln5prm
```
